...
if (SENDGRID_API_KEY) {
  ...
  console.log(
    "⚠️  SendGrid API key not found - using demo mode for verification codes",
  );
}
...
if (TWILIO_ACCOUNT_SID && TWILIO_AUTH_TOKEN && TWILIO_PHONE_NUMBER) {
  ...
  console.log(
    "⚠️  Twilio credentials not found - using demo mode for SMS codes",
  );
}
...
const verificationCodes = new Map<
  string,
  { code: string; expires: number; type: "email" | "phone" }
>();
